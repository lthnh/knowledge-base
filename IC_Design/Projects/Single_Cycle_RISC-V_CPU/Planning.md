...
RCA is pretty straightforward to implement. CLA is a bit harder. Brock only has a 4-bit example so it's not enough, but at least it gives me some intuition about CLA.
